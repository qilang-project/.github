...
| 仓库 | 说明 |
|------|------|
| [qi](https://github.com/qilang-project/qi) | 编译器核心 — 将奇语言源码编译为原生可执行文件 |
| [qi-lsp](https://github.com/qilang-project/qi-lsp) | 语言服务器 — 代码补全、诊断、格式化 |
...
- **纯中文关键字** — `如果` `否则` `当` `函数` `变量` `返回`
- **现代类型系统** — 静态类型、类型推断
- **异步运行时** — M:N 协程调度，基于工作窃取算法
- **跨平台** — macOS / Linux / Windows
- **完整工具链** — 编译器、LSP、格式化、IDE 扩展
